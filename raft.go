...
func (rt *Raft) GetState() (int, bool) {
...
//
func (rt *Raft) RequestVote(args *RequestVoteArgs, reply *RequestVoteReply) {
...
// need for a lock.
//
// the issue is taht that long-running goroutines use memory and may chew
